...
<%CustomerBean customerBean = (CustomerBean) session.getAttribute("customerBean");%>
 <section class="menu menu2 cid-szgCIDc2Di" once="menu" id="menu2-k">
    
    <nav class="navbar navbar-dropdown navbar-fixed-top navbar-expand-lg">
        <div class="container">
            <div class="navbar-brand">
                
                <span class="navbar-caption-wrap"><a class="navbar-caption text-black display-7" href="index.html">Hello, <%=customerBean.getName() %></a></span>
            </div>
